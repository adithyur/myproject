  ...
  return (
    <div>
      ...
      <div className="navbar2">
        <div className="nav-item2" style={{ paddingleft:'10px', paddingRight:'10px', color:'gray'}} onClick={()=>{navigate('/FreshProduct')}}>Fresh</div> 
        <div className="nav-item2" style={{ paddingleft:'10px', paddingRight:'15px', marginLeft:'-15px', color:'black'}} onClick={()=>{navigate('/ReProduct')}}>Refurbished</div>
